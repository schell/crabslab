...
//! [`SlabItem`](crate::slab::SlabItem).
//!
//! The functions and constants in this module are utilities to
//! help when writing manual implementations of
//! [`SlabItem`](crate::slab::SlabItem).
//!
//! Using these functions it's possible to "tightly pack" struct fields.
// TODO: write a doc example of a struct that has u8 and i8 fields that are
